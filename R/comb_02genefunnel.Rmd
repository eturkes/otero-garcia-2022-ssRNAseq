...
for (i in seq_along(seurat_list)) {
  ...
  keep <- filterByExpr(dge_orig, group = gse$tau)
  ...
  keep <- filterByExpr(dge_orig, group = deg$tau)
  dge_orig <- dge_orig[keep, ]
  dge_orig <- calcNormFactors(dge_orig)
